...
const faqs = [
  { q: "What are your operating hours?", a: "CR Fitness is open 24/7, 365 days a year. Our staffed hours are 6 AM to 10 PM on weekdays and 8 AM to 8 PM on weekends." },
