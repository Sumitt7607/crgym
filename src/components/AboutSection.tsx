        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="mt-8 flex gap-8">
              <div>
                <p className="text-3xl font-heading text-gradient-primary">98%</p>
                <p className="text-sm text-muted-foreground">Member Satisfaction</p>
              </div>
              <div>
                <p className="text-3xl font-heading text-gradient-primary">50+</p>
                <p className="text-sm text-muted-foreground">Weekly Classes</p>
              </div>
              <div>
                <p className="text-3xl font-heading text-gradient-primary">20+</p>
